    ...
    <div class="row w-100">
       <div class="col-md-8 mx-auto">
          <div class="card shadow">
             <form class="form-horizontal" action="{{ route('transaksi.update',$transaksi) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="card-body">
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-sm-9">
                        <input type="text" class="form-control" id="nama" name="nama"
                           placeholder="Masukkan Nama" value="{{ old('nama',$transaksi->nama) }}" />
                        @error('nama')
                  ...
                  <div class="form-group row mt-3">
                     ...
                     <div class="col-sm-9">
                        <input type="email" class="form-control" id="email" name="email"
                           placeholder="Masukkan Harga..." value="{{ old('email',$transaksi->email) }}" />
                        @error('email')
                           <small class="text-danger">{{ $message }}</small>
                        @enderror
                     </div>
                  ...
                  <div class="form-group row mt-3">
                     ...
                     <div class="col-sm-9">
                        <input type="number" class="form-control" id="no_hp" name="no_hp"
                           placeholder="Masukkan Harga..." value="{{ old('no_hp',$transaksi->no_hp) }}" />
                        @error('no_hp')
                           <small class="text-danger">{{ $message }}</small>
                        @enderror
                     </div>

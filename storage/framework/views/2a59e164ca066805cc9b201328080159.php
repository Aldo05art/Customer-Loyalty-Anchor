      ...
      <div class="row w-100">
         <div class="col-md-8 mx-auto">
            <div class="card shadow">
               <form class="form-horizontal" action="<?php echo e(route('sales.store')); ?>" method="POST">
                  <?php echo csrf_field(); ?>
                  <div class="card-body">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                           <input type="text" class="form-control" id="produk" name="produk"
                              placeholder="Masukkan Nama Produk..." value="<?php echo e(old('produk')); ?>" />
                     ...
                     <div class="form-group row mt-3">
                        ...
                        <div class="col-sm-9">
                           <input type="number" class="form-control" id="harga" name="harga"
                              placeholder="Masukkan Harga..." value="<?php echo e(old('harga')); ?>" />
...
<?php echo $__env->make('layouts.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\Documents\Praktikum Smt 3\pemweb\laravel\LaravelALDO\LaravelALDO\resources\views/sales/create.blade.php ENDPATH**/ ?>